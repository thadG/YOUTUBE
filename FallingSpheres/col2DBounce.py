...
depth = 3                        # number of sphere layers in y-direction
...
# add spheres in height and depth for loops
for z in range(height):
    for y in range(depth):
        bpy.ops.mesh.primitive_uv_sphere_add(location = [0, y * distance, z * distance])  # add primitive sphere
